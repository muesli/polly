...
func (context *PollyContext) LoadProposalByID(id int64) (DbProposal, error) {
	proposal := DbProposal{}
	if id < 1 {
...
func (context *PollyContext) GetProposalByID(id int64) (DbProposal, error) {
	proposal := DbProposal{}
	DbProposalCache, err := proposalsCache.Value(id, context)
	if err != nil {
		return proposal, err
	}

	proposal = *DbProposalCache.Data().(*DbProposal)
	return proposal, nil
}

// LoadAllProposals loads all proposals from the database
func (context *PollyContext) LoadAllProposals() ([]DbProposal, error) {
...
func (proposal *DbProposal) Update(context *PollyContext) error {
...
func (proposal *DbProposal) Save(context *PollyContext) error {
